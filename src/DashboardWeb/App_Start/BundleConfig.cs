...
namespace DashboardWeb
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/lib").Include(ltecomponents + "jquery-ui/jquery-ui.min.js")
            ...
            bundles.Add(new ScriptBundle("~/bundles/dashboard").Include(lte + "js/pages/dashboard.js"));
